            ...
            <div id="topnav" className="defaultscroll sticky">
                ...
                <div id='navigation'>
                    <ul className='navigation-menu'>
                        ...
                        <li>
                        <Link to="/login" className="header-quote" title="Send Enquiry">
                        <span style={{ backgroundColor: 'red', padding: '15px', borderRadius: '25px', color: 'white', marginTop: '350px' }} onClick={handleLogout}>
                            LOGOUT
                        </span>
                        </Link>
                        </li>
