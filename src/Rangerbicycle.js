...
function Rangerbicycle(){
    const [formData, setFormData] = useState({
        ...
        location: '',
        message: '',
        product: 'Ranger-Bicycle', // Initialize the product here
      });
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center">
                            <h4 class="cat_title">Ranger Bicycle Manufacturers</h4>
                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Ranger Bicycle</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="noSidebarFull col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-9 col-md-push-3">
                            <div class="right_side">
                                <div class="title_holder_inner">
                                    <h1 class="cat-widget-title">Racing Bicycle Manufacturers in Delhi</h1>                                                                </div>

                                    <div class="wps_right">
                                    <div class="product_right_image">
                                        <div class="gallery slick-initialized slick-slider">
                                            <div class="slick-list draggable">
                                                <div class="slick-track" style={{opacity: 1, width: '400px', transform: 'translate3d(0px, 0px, 0px)'}}>
                                                    <div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style={{width: '400px'}}>
                                                        <div>
                                                            <div class="service_item wow fadeInDown" data-wow-delay=".0.2s" style={{width: '100%', display: 'inline-block'}}>
                                                <div class="service-block">
                                                    <div class="inner-box">
                                                        <div class="image-box" data-imgsrc="">
                                                            <figure class="image">
                                                                <img class="product-img" src="https://firecatcher.in/admin/uploads/category/subcategory-23-09-2023-1695465758-Bicycle Suppliers In Delhi (10).webp" alt="Mountain Bicycle Manufacturers in Delhi" title="Mountain Bicycle Manufacturers in Delhi" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <span style={{fontSize: '15px'}}>We are famous <b>Ranger Bicycle Manufacturers In Delhi</b> because our team makes cycles extra strong, looks really cool, and pays close attention to even the tiniest things. We make all kinds of cycles for different types of riding, like on the road, in the mountains, in the city, and just for fun. Every bike we make is carefully
                                     created using fancy materials and the newest technology. This ensures the bikes work well and last a long time.</span>
                                    </font>
                                    </p>
                                    <h3 style={{ fontFamily: 'Poppins, sans-serif', color: 'rgb(51, 51, 51)', marginTop: '10px', marginBottom: '5px', fontSize: '20px', fontWeight: '600', overflow: 'hidden', padding: '0', lineHeight: '30px' }}>Ranger Bicycle Suppliers In Delhi</h3>
                                    <p style={{ marginRight: '0px', marginBottom: '10px', marginLeft: '0px', lineHeight: '24px', textAlign: 'justify' }}><font color="#363636" face="Poppins, sans-serif"><span style={{fontSize: '15px'}}>Being one of the top <b>Ranger Bicycle Suppliers In Delhi</b> our company has made sure our bikes are easy to get in Delhi. We have set up lots of stores where you can buy the cycles. Also, as an aware </span></font>
                                    <font color="#363636" face="Poppins, sans-serif" style={{fontSize: '0.875rem'}}><span style={{fontSize: '15px'}}><b>Ranger bicycle wholesale suppliers in India </b>, we have noticed that not only people like you and me want cycles, but also big groups like companies, schools, and gyms want them. So, we have also started selling a lot of bikes all at once to these big groups.  </span></font>
                                    <span style={{color: 'rgb(54, 54, 54)', fontFamily: 'Poppins, sans-serif', fontSize: '15px'}}>&nbsp;</span></p>
                                    <h3 style={{ fontFamily: 'Poppins, sans-serif', color: 'rgb(51, 51, 51)', marginTop: '10px', marginBottom: '5px', fontSize: '20px', fontWeight: '600', overflow: 'hidden', padding: '0', lineHeight: '30px' }}>Ranger Bicycle Dealers In Delhi</h3>
                                    <p style={{ marginRight: '0px', marginBottom: '10px', marginLeft: '0px', lineHeight: '24px', textAlign: 'justify' }}><font color="#363636" face="Poppins, sans-serif"><span style={{fontSize: '15px'}}>Customization is another aspect that sets us apart as prominent <b>Raneer Bicycle Dealers In Delhi</b> So, if a company, school, or event wants to have its own name, logo, or favorite colors on the bicycles, we can do that! It's like making the bikes look just how you want.
                                     So, these bikes aren't just for riding; they also help you tell everyone about your special brand and act as a free marketing tool.
                                     </span></font>
                                    </p>                                    
                                    ...
                                    <div id="prodListingContainer">
                                        <div class="product_listing listpager">
                                            <div class="row">
                                                    ...
                                                    <div class="product">
                                                        <a href="/bicycles/City-bicycle" title="City Bicycle Manufacturers">
                                                            <div class="image1" data-imgsrc="">
                                                                <img src="https://firecatcher.in/admin/uploads/category/subcategory-23-09-2023-1695465809-Bicycle Suppliers In Delhi (18).webp" title="City Bicycle Manufacturers in Delhi" alt="City Bicycle Manufacturers in Delhi" class="img-responsive product-img" />
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-12 col-12">
                                                    <div class="right-content">
                                                        <h4 class="title_h3">
                                                            <a href="/bicycles/City-Bicycle" title="City Bicycle Manufacturers">City Bicycle</a></h4>
                                            ...
                                            <div class="row">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-12 col-12">
                                                    <div class="product">
                                                        <a href="/bicycles/Racing-bicycle" title="Ranger Bicycle Manufacturers">
                                                            <div class="image1" data-imgsrc="">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-12 col-12">
                                                    <div class="right-content">
                                                        <h4 class="title_h3"><a href="/bicycles/Racing-bicycle" title="Ranger Bicycle Manufacturers">Racing Bicycle</a></h4>
                                            ...
                                            <div class="row">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-12 col-12">
                                                    <div class="product">
                                                        <a href="/bicycles/Folidng-bicycles" title="Folding Bicycle Manufacturers">
                                                            <div class="image1" data-imgsrc="">
                                                                <img src="https://firecatcher.in/admin/uploads/category/subcategory-23-09-2023-1695465708-Bicycle Suppliers In Delhi (15).webp" title="Folding Bicycle Manufacturers in Delhi" alt="Folding Bicycle Manufacturers in Delhi" class="img-responsive product-img" />
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-12 col-12">
                                                    <div class="right-content">
                                                        <h4 class="title_h3"><a href="/bicycles/Folding-bicycle" title="Folding Bicycle Manufacturers">Folding Bicycle</a></h4>
                                                        ...
                                                        <a href="/bicycles/Folding-bicycle" class="read_more_product" title="Read More">Read More <i class="fa fa-long-arrow-right fa-1x"></i></a>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-12 col-12">
                                                    <div class="right-content">
                                                        ...
                                                        <a href="/bicycles/Mountain-bicycle" class="read_more_product" title="Read More">Read More <i class="fa fa-long-arrow-right fa-1x"></i>
                                                        </a>    
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <ul>
                                    <li class="cs_subm">
                                        ...
                                        <ul class="cs_subdown">
                                            ...
                                            <li class="cs_subm">
                                                <a href="bicycles/Ranger-Bicycle" title="Ranger Bicycle">Ranger Bicycle </a>   
                                                <ul class="cs_subdown"></ul>   
                                            </li>

                                            <li class="cs_subm">
                                                <a href="bicycles/Mountain-Bicycle" title="Mountain Bicycle">Mountain Bicycle</a>                                                
                                                <ul class="cs_subdown"></ul>    
                                            </li>
                                            
                                             <li class="cs_subm">
                                                <a href="bicycles/Folding-Bicycle" title="Folding Bicycle">Folding Bicycle</a>                                                  
                                                <ul class="cs_subdown"></ul>    
                                            </li>
