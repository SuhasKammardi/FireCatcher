...
function Mountainbicycle(){
    const [formData, setFormData] = useState({
        ...
        location: '',
        message: '',
        product: 'Mountain-Bicycle', // Initialize the product here
      });
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center">
                            <h4 class="cat_title">Mountain Bicycle Manufacturers</h4>
                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Mountain Bicycle</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="noSidebarFull col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-9 col-md-push-3">
                            <div class="right_side">
                                <div class="title_holder_inner">
                                    ...
                                    <span style={{fontSize: '15px'}}>As prominent <b>Mountain Bicycle Manufacturers In Delhi</b>, our team is super careful and tests each bicycle a lot to make sure it's awesome. We even look at every little part of the bicycle, like the tiny screws and the special gears, very closely. We do all this to be sure the bicycles are as great as we want them to be.&nbsp;</span></font>
                                    <span style={{fontSize: '15px', fontFamily: 'Poppins, sans-serif'}}>This dedication to make bicycles really good isn't only about selling. It's about making bicycles so awesome that it's even better than what you hoped for.</span></p>
                                    <h3 style={{ fontFamily: 'Poppins, sans-serif', color: 'rgb(51, 51, 51)', marginTop: '10px', marginBottom: '5px', fontSize: '20px', fontWeight: '600', overflow: 'hidden', padding: '0', lineHeight: '30px' }}>Mountain Bicycle Suppliers In Delhi</h3>
                                    <p style={{ marginRight: '0px', marginBottom: '10px', marginLeft: '0px', lineHeight: '24px', textAlign: 'justify' }}><font color="#363636" face="Poppins, sans-serif"><span style={{fontSize: '15px'}}>What makes us special <b>Mountain Bicycle Suppliers In Delhi</b> is that we work really hard to make cycles super well and come up with new ideas. We even make sure all the small parts work perfectly together.&nbsp;</span></font>
                                    <font color="#363636" face="Poppins, sans-serif" style={{fontSize: '0.875rem'}}><span style={{fontSize: '15px'}}>As one of the top <b>Mountain Bicycle Wholesale Supplier in Delhi</b>, we know what stores and businesses need. We allow stores to order lots of bicycles all at once! Whether it's a tiny cycle shop in the neighborhood or a big store that sells sports stuff, our team makes sure they can get as many bicycles as they need.</span></font>
                                    <span style={{color: 'rgb(54, 54, 54)', fontFamily: 'Poppins, sans-serif', fontSize: '15px'}}>&nbsp;</span></p>
                                    <h3 style={{ fontFamily: 'Poppins, sans-serif', color: 'rgb(51, 51, 51)', marginTop: '10px', marginBottom: '5px', fontSize: '20px', fontWeight: '600', overflow: 'hidden', padding: '0', lineHeight: '30px' }}>Mountain Bicycle Dealers In Delhi</h3>
                                    <p style={{ marginRight: '0px', marginBottom: '10px', marginLeft: '0px', lineHeight: '24px', textAlign: 'justify' }}><font color="#363636" face="Poppins, sans-serif"><span style={{fontSize: '15px'}}>People prefer us as their trusted <b>Mountain Bicycle Dealers In Delhi</b> because we are really helpful to them. We answer your questions, help track orders, and make sure everything is okay even after the sale is done.&nbsp;</span></font>
                                    <span style={{fontSize: '15px', fontFamily: 'Poppins, sans-serif'}}>Because we work with businesses in a way that's good for both of us, we have been able to grow and get bigger. Our teamwork has made us successful.</span></p>                                    <div class="product-single">
...
export default Mountainbicycle